...
{
    [DesignerGenerated()]
    public partial class processDatabaseInsertRows : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            Name = "processDatabaseInsertRows";
            StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            Text = "Insert Selected Rows";
            TopMost = true;
            Load += new EventHandler(processDatabaseInsertRows_Load);
            ResumeLayout(false);
            PerformLayout();
        }
