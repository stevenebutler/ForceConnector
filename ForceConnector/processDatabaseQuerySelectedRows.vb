...
Public Class processDatabaseQuerySelectedRows
    ...
    Private Sub processDatabaseQuerySelectedRows_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
...
errors:
    ...
    Private Sub bgw_DoWork(sender As Object, e As DoWorkEventArgs) Handles bgw.DoWork
        ...
        Try
            ...
            Dim sels As String
            sels = getSelectionList(g_header)
            ...
            Do ' build a chunk Range which covers the cells we can query in a batch
                ...
                If Not querySelectedRow(excelApp, worksheet, g_header, g_body, g_ids, g_objectType, g_sfd, sels, chunk, outrow, totals, bgw) Then GoTo done ' do it
