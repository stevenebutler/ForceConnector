...
Public Class processDatabaseUpdateRows
    ...
    Private Sub processDatabaseUpdateRows_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
...
errors:
    ...
    Private Sub bgw_DoWork(sender As Object, e As DoWorkEventArgs) Handles bgw.DoWork
        ...
        Try
            ...
            If Not UpdateLimitCheck(excelApp.Selection, statusText) Then GoTo errors
            ...
            row_counter = 0
            Dim msg As String = "You try to update " & totals.ToString("N0") & " records. Are you sure?"
            Dim result As DialogResult = TopMostMessageBox.Show("Update Information", msg, MessageBoxButtons.OKCancel, MessageBoxIcon.Question)
            ...
            Do ' build a chunk Range which covers the cells we can update in a batch
                ...
                updateRange(excelApp, g_header, g_objectType, g_start, g_sfd, g_ids, chunk, someFailed, row_counter, totals, bgw)

                Dim sav As Excel.Range
                sav = excelApp.Selection ' save the selection
            ...
            If someFailed Then
                ErrorBox("One or more of the selected rows could not be updated" & Chr(10) &
...
errors:
        ...
        excelApp.StatusBar = "Update : update complete, " & row_counter - 1 & " total rows returned"
